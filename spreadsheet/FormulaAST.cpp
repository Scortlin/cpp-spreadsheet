    ...
    double Evaluate(const SheetInterface& arg) const override {
        ...
        switch (type_) {
            ...
            case Multiply:
                ...
                return lhs_value * rhs_value;
            case Divide:
                if(rhs_value == 0 || isinf(lhs_value / rhs_value)) {
                    throw FormulaError{FormulaError::Category::Div0};
                }
                return lhs_value / rhs_value;
            default:
...
private:
    struct CellVisitor {
        ...
        double operator() (FormulaError& f) const {
            throw f;
        }
    };
public:
    ...
    double Evaluate(const SheetInterface& arg) const override {
        ...
        auto result = visit(CellVisitor(), value);
        return result;
    }
